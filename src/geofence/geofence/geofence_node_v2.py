...
class GPSSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.folder_path = "/home/irobot/ros2_ws/src/geofence/geofence"
    ...
    def update_map(self):
        if self.closest_vineyard is not None:
            if self.latitude is not None and self.longitude is not None and self.closest_vineyard is not None:
                ...
                for name, polygon in self.vineyard_polygons:
                    folium.GeoJson(polygon, name=name, style_function=lambda x: borderStyle).add_to(self.m)
                ...
                get_status=self.get_gps_status()
                ...
                legend_html = '''
                    <div style="position: fixed; 
                                bottom: 50px; right: 50px; width: 400px; height: 150px; 
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 5px;">
                            ...
                            <span style="margin-left: 5px;">{inside_text} {weinbergsname}</span>
                        </div>
                    ...
                    '''.format(inner_color=inner_color, 
                            ...
                            inside_text2="Kürzester Abstand zur Begranzung" if self.inside_polygon else text,
                            gps_status=get_status,
